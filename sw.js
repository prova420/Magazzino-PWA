...
// sw.js - Aggiorna la versione
const CACHE_NAME = 'magazzino-pwa-v6'; // Cambia da v5 a v6
const APP_VERSION = '6.0.0'; // Aggiorna versione
const DATA_CACHE_NAME = 'magazzino-data-v2';

// sw.js - PERCORSI RELATIVI CORRETTI
...
self.addEventListener('fetch', (event) => {
    ...
    // NUOVO: Gestione specifica per API (Network Only)
...
// Gestione richieste che non devono essere cacheate (API dinamiche)
